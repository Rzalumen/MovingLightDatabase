...
new.append(f(
    brand="Elation", model="Proteus Hybrid",
    category="Spot", variant="",
    applications=["Touring","Install","Concert"],
    tier="Medium", lampType="Discharge", watts=470,
    cct="8000K", cctRange="",
    outputLumens=14000, cri=80, criRaw="CRI 80",
    zoomMin=2, zoomMax=40, zoomRatio="", zoomRaw="2° (beam) - 38° (spot) / 40° (wash)",
    colorMixing="CMY + linear CTO",
    framing=False,
    gobo="8 rotating glass + 14 static metal",
    animationWheel=True, prism=True, frost=True,
    effectsRaw="14-position colour wheel (CTB/CTO/UV); full 360° bi-directional animation wheel; 8-facet circular + 4-facet linear rotating prisms; frost",
    ipRating="IP65",
    protocols="DMX, RDM, Art-Net, sACN, E-FLY wireless",
    standout="Original IP65 hybrid (predecessor to Hybrid Max)\n(discontinued)",
    lamp="470W Philips MSD 21R",
    link="https://www.elationlighting.eu/proteus-hybrid",
    description="First-generation IP65 beam/spot/wash hybrid that established Elation's Proteus line. 470 W Philips MSD 21R lamp, 14,000 lm, with E-FLY wireless DMX onboard.",
    ipRated=True,
    imageUrl="",
))

new.append(f(
    brand="Elation", model="Smarty Hybrid",
    category="Spot", variant="",
    applications=["Touring","Theater","Install"],
    tier="Medium", lampType="Discharge", watts=280,
    cct="", cctRange="",
    outputLumens=11000, cri=None, criRaw="",
    zoomMin=1, zoomMax=33, zoomRatio="", zoomRaw="1° (beam) - 18° / 3°-27° (spot) / 5°-33° (wash)",
    colorMixing="CMY (subtractive)",
    framing=False,
    gobo="8 rotating + 12 static metal",
    prism=True, frost=True,
    effectsRaw="13-position colour wheel; motorised focus & zoom; 5-facet + 16-facet rotating prisms; frost; selectable 190/240/280 W lamp modes; E-FLY wireless DMX",
    ipRating="IP20",
    dmxChannels="20 / 34",
    protocols="DMX, RDM, Art-Net, sACN, E-FLY wireless",
    standout="Compact 280W indoor hybrid — 11,000 lm\n(discontinued)",
    lamp="280W Philips MSD Platinum Flex 200",
    link="https://www.elationlighting.com/products/smarty-hybrid",
    description="Compact indoor beam/spot/wash hybrid using the 280 W Philips MSD Platinum Flex 200 lamp with selectable wattage modes (190/240/280 W). Three zoom ranges by mode; 49 lb body.",
    imageUrl="",
))

new.append(f(
    brand="Elation", model="Proteus Smarty Hybrid",
    category="Spot", variant="",
    applications=["Touring","Install","Concert"],
    tier="Medium", lampType="Discharge", watts=280,
    cct="", cctRange="",
    outputLumens=11000, cri=None, criRaw="",
    zoomMin=1, zoomMax=33, zoomRatio="", zoomRaw="1° (beam) - 33° (wash)",
    colorMixing="CMY",
    framing=False,
    gobo="Rotating + static",
    prism=True, frost=True,
    effectsRaw="Dual prism, frost, auto-focus; Flex lamp technology 190–280 W with lamp hibernation; IP65 connectors (XLR / etherCON / Powerkon)",
    weightKg=35, ipRating="IP65",
    protocols="DMX, RDM, Art-Net, sACN",
    standout="IP65 version of the Smarty Hybrid — 11,000 lm\n(discontinued)",
    lamp="280W Philips MSD Platinum 200 Flex",
    link="https://www.elationlighting.com/products/proteus-smarty-hybrid",
    description="IP65 outdoor variant of the Smarty Hybrid with the same Flex lamp tech (190–280 W) and 11,000 lm output. 35 kg body with IP65-rated connectors throughout.",
    ipRated=True,
    imageUrl="",
))
